...
function isTransient(err) {
  ...
  // A SyntaxError means the response body itself was unparseable -- permanent,
  // no matter what words happen to appear in the offending text Node quotes
  // into the message (e.g. an unparseable string containing "rate limit" would
  // otherwise false-match TRANSIENT_MESSAGE below).
