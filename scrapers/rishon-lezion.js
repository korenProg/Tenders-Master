async function scrape(page) {
  ...
  while (hasNextPage && currentPage <= maxPages) {
    console.log(`📄 Processing Rishon Lezion - Page ${currentPage}...`);
    
    // גלילה קלה להבטיח שהתוכן והאלמנטים נטענים
    ...
    if (!currentText || currentText.length < 500 || currentText.includes("Page not found")) {
      console.log(`🏁 Reached an empty page or 404 text at Rishon Lezion page ${currentPage}. Stopping.`);
      break;
    }
